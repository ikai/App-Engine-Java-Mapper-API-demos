...
/**
 * 
 * This mapper counts the number of total words across all comments. It cheats
 * a bit by just splitting on whitespace and just using the length. This mapper
...
public class CountWordsMapper extends
	...
	/* 
	 * This is a bit of a lazy implementation more to prove a point than
	 * to actually be correct. Split on whitespace, count words 
	 */
	@Override
	public void map(Key key, Entity value, Context context) {
		...
		if(comment != null) {
			...
			// We'll use these later to store the final count back in the datastore
